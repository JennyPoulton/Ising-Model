...
void System::Peturb_Particle()
{
	...
	if((Lattice[Current_Row_One][Current_Column_One].Return_Spin()==MAXSPIN&&Lattice[Current_Row_Two][Current_Column_Two].Return_Spin()==MAXSPIN)||(Lattice[Current_Row_One][Current_Column_One].Return_Spin()==-MAXSPIN&&Lattice[Current_Row_Two][Current_Column_Two].Return_Spin()==-MAXSPIN))
	{
		return;
	}
	else if(Lattice[Current_Row_One][Current_Column_One].Return_Spin()==MAXSPIN&&Lattice[Current_Row_Two][Current_Column_Two].Return_Spin()==-MAXSPIN)
	{
